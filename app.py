        ...
        st.markdown(f'''<div class="glass-card">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;">
                <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
                    ...
                    <span style="font-family:Syne,sans-serif;font-weight:700;font-size:1rem;
                        color:#e8edf8;">{gname}</span>
                    {done_badge}
                </div>
                <div style="text-align:right;min-width:120px;">
                    <div style="font-family:DM Mono,monospace;font-size:1.05rem;font-weight:500;color:{fill};">
                        Rs{gsaved:,.0f} <span style="color:#444;font-size:0.78rem;">/ Rs{gtarget:,.0f}</span></div>
            ...
            <div class="budget-bar-bg">
                <div class="budget-bar-fill" style="width:{pct:.1f}%;background:{fill};
                    box-shadow:0 0 8px {fill}44;"></div>
            </div>
            <div style="font-size:0.7rem;color:#444;font-family:DM Mono,monospace;
                display:flex;justify-content:space-between;margin-top:2px;">
                <span>{pct:.1f}% complete</span>
                <span>deadline {gdeadline}</span>
            </div>
        </div>''', unsafe_allow_html=True)
