...
html, body, [data-testid="stAppViewContainer"] {
    ...
    color: var(--sbi-text) !important;
    font-family: 'Inter', sans-serif !important;
}
[data-testid="stAppViewContainer"] > .main { background: var(--sbi-bg) !important; }
...
[data-testid="stSidebar"] [role="radiogroup"] [aria-checked="true"] {
    ...
    border-left: 3px solid var(--sbi-orange) !important;
...
[data-testid="stTextArea"] textarea {
    ...
    border: 1.5px solid var(--sbi-border) !important;
    border-radius: 8px !important;
    color: var(--sbi-text) !important;
    -webkit-text-fill-color: var(--sbi-text) !important;
    caret-color: var(--sbi-blue) !important;
    font-family: 'Inter', sans-serif !important;
...
input::placeholder { color: #9aa3b8 !important; -webkit-text-fill-color: #9aa3b8 !important; }
...
[data-baseweb="select"] * { color: var(--sbi-text) !important; }
label, [data-testid="stWidgetLabel"] p {
    color: var(--sbi-muted) !important;
    font-size: 0.8rem !important;
    font-weight: 500 !important;
    -webkit-text-fill-color: var(--sbi-muted) !important;
}
...
.stButton > button:hover {
    background: var(--sbi-blue-mid) !important;
...
.stDownloadButton > button {
    background: #ffffff !important;
    border: 1.5px solid var(--sbi-blue) !important;
    color: var(--sbi-blue) !important;
    -webkit-text-fill-color: var(--sbi-blue) !important;
    border-radius: 8px !important;
    font-weight: 600 !important;
}
...
[data-testid="metric-container"] {
    background: #ffffff !important;
    border: 1px solid var(--sbi-border) !important;
    border-radius: 12px !important;
    padding: 1rem 1.2rem !important;
    box-shadow: 0 1px 4px rgba(0,51,153,0.06) !important;
}
...
[data-testid="stProgressBar"] > div > div {
    background: linear-gradient(90deg, var(--sbi-blue), var(--sbi-orange)) !important;
    border-radius: 999px !important;
}
[data-testid="stProgressBar"] > div {
    background: var(--sbi-off) !important; border-radius: 999px !important;
}
...
[data-testid="stExpander"] {
    ...
    border: 1px solid var(--sbi-border) !important;
    border-radius: 10px !important;
    box-shadow: 0 1px 4px rgba(0,51,153,0.04) !important;
}
[data-testid="stExpander"] summary { color: var(--sbi-text) !important; font-weight: 500 !important; }

/* ── Alerts ── */
[data-testid="stAlert"] {
    border-radius: 10px !important;
    border-left: 4px solid var(--sbi-blue) !important;
    background: rgba(0,51,153,0.05) !important;
}
[data-testid="stAlert"] p { color: var(--sbi-text) !important; -webkit-text-fill-color: var(--sbi-text) !important; }
...
[data-testid="stForm"] {
    ...
    box-shadow: 0 2px 8px rgba(0,51,153,0.06) !important;
}

/* ── Divider ── */
hr { border-color: var(--sbi-border) !important; }

/* ── Scrollbar ── */
::-webkit-scrollbar { width: 5px; height: 5px; }
::-webkit-scrollbar-track { background: var(--sbi-off); }
::-webkit-scrollbar-thumb { background: var(--sbi-blue); border-radius: 4px; opacity: 0.5; }

/* ── Page transition ── */
[data-testid="stMainBlockContainer"] {
    animation: pageFadeIn 0.3s ease-out !important;
}
...
.fv-ticker-wrap {
    ...
    background: var(--sbi-blue);
    padding: 7px 0; margin-bottom: 1.2rem;
    border-radius: 8px;
}
.fv-ticker {
...
.fv-hero-stats {
    display: flex; gap: 1.8rem; margin-top: 1.2rem; flex-wrap: wrap;
}
.fv-hero-stat { display: flex; flex-direction: column; }
.fv-hero-stat-val {
...
.fv-kpi-card {
    ...
    position: relative; overflow: hidden;
    box-shadow: 0 1px 6px rgba(0,51,153,0.07);
...
.fv-kpi-income::before  { background: var(--sbi-success); }
.fv-kpi-expense::before { background: var(--sbi-danger); }
.fv-kpi-savings::before { background: var(--sbi-orange); }
.fv-kpi-score::before   { background: var(--sbi-blue); }
.fv-kpi-card::after {
    content: ""; position: absolute;
    top: -20px; right: -15px;
    width: 70px; height: 70px; border-radius: 50%; opacity: 0.06;
}
.fv-kpi-income::after  { background: #0a7c42; }
.fv-kpi-expense::after { background: #c0392b; }
.fv-kpi-savings::after { background: #f47920; }
.fv-kpi-score::after   { background: #003399; }
.fv-kpi-tag {
...
.fv-kpi-label {
    font-size: 0.68rem; color: var(--sbi-muted);
    font-family: 'Inter', sans-serif;
    text-transform: uppercase; letter-spacing: 0.07em;
    -webkit-text-fill-color: var(--sbi-muted);
}
.fv-sparkline { margin-top: 8px; opacity: 0.8; }
...
.fv-chart-card {
    ...
    margin-bottom: 1rem;
    box-shadow: 0 1px 6px rgba(0,51,153,0.06);
    transition: box-shadow 0.2s;
}
.fv-chart-card:hover { box-shadow: 0 4px 16px rgba(0,51,153,0.1); }

/* ── Section title ── */
.section-tag {
    display: inline-block; font-family: 'Inter', sans-serif;
    font-size: 0.65rem; font-weight: 600; padding: 2px 10px;
    border-radius: 4px; background: rgba(0,51,153,0.08);
    color: var(--sbi-blue); letter-spacing: 0.1em;
    margin-bottom: 3px; text-transform: uppercase;
}
.fv-section-title {
    font-family: 'Inter', sans-serif; font-size: 1rem;
    font-weight: 600; color: var(--sbi-text); margin-bottom: 0.8rem;
}
...
.fv-page-sub {
    font-size: 0.78rem; color: var(--sbi-muted);
...
.kpi-pill {
    display: inline-block; font-family: 'Inter', sans-serif;
    font-size: 0.67rem; font-weight: 600; padding: 2px 10px;
    border-radius: 4px; letter-spacing: 0.05em; margin-bottom: 6px;
}
.kpi-pill-green { background: rgba(10,124,66,0.1);  color: #0a7c42; border: 1px solid rgba(10,124,66,0.2); }
.kpi-pill-gold  { background: rgba(244,121,32,0.1); color: #c87010; border: 1px solid rgba(244,121,32,0.2); }
.kpi-pill-red   { background: rgba(192,57,43,0.1);  color: #c0392b; border: 1px solid rgba(192,57,43,0.2); }
.kpi-pill-cyan  { background: rgba(0,51,153,0.08);  color: var(--sbi-blue); border: 1px solid rgba(0,51,153,0.15); }
...
/* ── Budget bars ── */
.budget-bar-bg {
    background: var(--sbi-off); border-radius: 999px;
...
/* ── Invest cards ── */
.invest-card {
    background: #ffffff; border: 1px solid var(--sbi-border);
    border-radius: 10px; padding: 0.9rem 1.1rem;
    margin-bottom: 0.55rem; transition: box-shadow 0.2s;
    box-shadow: 0 1px 4px rgba(0,51,153,0.05);
}
.invest-card:hover { box-shadow: 0 4px 12px rgba(0,51,153,0.1); }
.invest-name { font-weight: 600; font-size: 0.9rem; color: var(--sbi-text); margin-bottom: 2px; }
.invest-desc { font-size: 0.76rem; color: var(--sbi-muted); font-family: 'Inter', sans-serif; }

/* ── Home features ── */
.home-feature {
    background: #ffffff; border: 1px solid var(--sbi-border);
    border-radius: 10px; padding: 0.85rem 1rem;
    margin-bottom: 0.45rem; font-size: 0.86rem;
    color: var(--sbi-text); display: flex; gap: 10px;
    align-items: center; box-shadow: 0 1px 4px rgba(0,51,153,0.05);
    -webkit-text-fill-color: var(--sbi-text);
}
.home-feature span { color: var(--sbi-blue); font-size: 1.05rem; }
...
.fv-bottom-nav a {
    ...
    gap: 3px; text-decoration: none; color: rgba(255,255,255,0.6);
...
.fv-bottom-nav a:hover { color: #ffffff; }
.fv-bottom-nav a svg { width: 20px; height: 20px; stroke-width: 1.5; }

/* ── kpi-big / kpi-label-sm for non-dashboard pages ── */
.kpi-big {
...
.kpi-label-sm {
    font-size: 0.7rem; color: var(--sbi-muted);
    font-family: 'Inter', sans-serif;
...
@media (max-width: 768px) {
    ...
    .fv-kpi-val { font-size: 1.1rem !important; }
    .fv-hero-greeting { font-size: 1.2rem !important; }
...
@media (max-width: 480px) {
    .fv-kpi-grid { grid-template-columns: repeat(2, 1fr) !important; }
...
CYAN     = "#00dcff"
PURPLE   = "#5b6abf"
PALETTE  = ["#003399","#f47920","#0a7c42","#c0392b","#5b6abf","#e8a020","#1a5fd4","#7b8ec8"]
...
# ─────────────────────────────────────────
    ...
    st.markdown(f'''<div class="fv-kpi-grid">
        <div class="fv-kpi-card fv-kpi-income">
            <div class="fv-kpi-tag" style="background:rgba(10,124,66,0.1);color:#0a7c42;">INCOME</div>
            <div class="fv-kpi-val" style="color:#0a7c42;">₹{total_inc:,.0f}</div>
            <div class="fv-kpi-label">Total Income</div>
            <div class="fv-sparkline">{_inc_spark}</div>
        </div>
        <div class="fv-kpi-card fv-kpi-expense">
            <div class="fv-kpi-tag" style="background:rgba(192,57,43,0.1);color:#c0392b;">EXPENSE</div>
            <div class="fv-kpi-val" style="color:#c0392b;">₹{total_exp:,.0f}</div>
        ...
        <div class="fv-kpi-card fv-kpi-score">
            <div class="fv-kpi-tag" style="background:rgba(0,51,153,0.08);color:#003399;">SCORE</div>
            <div class="fv-kpi-val" style="color:#003399;">{score}<span style="font-size:1rem;color:#9aa3b8;">/100</span></div>
