...
.fv-hero-sub {
    ...
    color: #666; letter-spacing: 0.04em; margin-top: 2px;
    line-height: 1.5;
}
.fv-hero-stats {
...
# ─────────────────────────────────────────
    ...
    if 5 <= _hour < 12:
        _greet = "Good Morning"
        _greet_sub = "Markets are open. Here is your financial overview."
    elif 12 <= _hour < 17:
        _greet = "Good Afternoon"
        _greet_sub = "Midday financial review. Stay on track."
    elif 17 <= _hour < 21:
        _greet = "Good Evening"
        _greet_sub = "End of day summary. Review your numbers."
    else:
        _greet = "Good Night"
        _greet_sub = "Your finances are in order. Rest well."
    ...
    st.markdown(f'''<div class="fv-hero">
        <div class="fv-hero-greeting">{_greet}, {st.session_state.username}</div>
